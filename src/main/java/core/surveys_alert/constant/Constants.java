package core.surveys_alert.constant;
...
public final class Constants {
    ...
    public static final String QUESTION_STATUS = "Qual a situação do produto?";
    public static final String QUESTION_PRICE = "Qual o preço do produto?";
